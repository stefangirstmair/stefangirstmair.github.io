...
\cventry{January 2024--May 2024}{Consultant}{}{ECB - European Central Bank - Forecasting and Policy Modelling Division (DGE)}{Frankfurt am Main}{\emph{Continue the work on the model established during the traineeship and co-author a paper describing its features.}}

\cventry{May 2023--September 2023}{PhD-Trainee}{}{ECB - European Central Bank - Forecasting and Policy Modelling Division (DGE)}{Frankfurt am Main}{\emph{Developing a linked version of the semi-structural ECB-MC model mainly used for forecasting and policy analysis.}}

\cventry{October 2018--}{Graduate Research and Teaching Assistant}{Chair of International
	Macroeconomics and Macroeconometrics}{Goethe University}{Frankfurt am Main}{}

\cventry{July 2015}{Intern}{}{OeNB - Austrian National Bank - Economic Analysis Department, Forecasting}{Vienna}{\emph{Updating a database used for forecasts as well as computations for internal and external papers. Using ECB, Statistik Austria, and Eurostat data}.}

\cventry{July 2014}{Intern}{}{OeNB - Austrian National Bank - Economic Analysis Department, Forecasting}{Vienna}{\emph{Data processing to help write a paper on labor productivity developments in Austria compared to the U.S.. Main work on setting up and analyzing the database}.}
